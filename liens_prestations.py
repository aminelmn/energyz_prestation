...
def get_info_energyz(item_id, column_ids=2024323737):
    # API endpoint
...
async def to_pay_energyz_prest(request: Request):
    ...
    try:
        ...
        column_ids = ['location_mksap4tf', 'email_mksa3z84', 'formula_mksadzsw', 'text_mksa2v7e']
